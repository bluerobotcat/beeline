...
def get_all_dishes():
    ...
    """
    try:
        # Use a buffered cursor with context management
        ...
        # Handle any exceptions, logging the error for debugging
        print(f"Error occurred: {e}")
        # You can change the response to return an appropriate error message and status code
        return {"error": "An error occurred while fetching dishes"}, 500
